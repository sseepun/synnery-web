...
<body class="loading">
    ...
    <section class="section-padding bg-sec" data-aos="fade-in" data-aos-delay="300" style="background-image: url('public/img/bg/100.png');">
        <div class="container">
            <?php
            // จำนวนข้อมูลทั้งหมด
            ...
            foreach ($currentPageData as $index => $data) {
                ?>
                <div class="max-width-960 <?= ($index % 2 == 0)?'tool-odd':'tool-even' ?>">
                    <div class="row">
            ...
            if(!empty($totalPages)) {
                echo '<div class="paginations text-sm pt-5" data-aos="fade-up" data-aos-delay="500">';
