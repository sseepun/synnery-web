...
<body class="loading">
  ...
  <section data-section="2" class="section-01 section-padding size-03">
    ...
    <div class="container">
      ...
      <div class="ss-card ss-card-06 mt-2">
        <img class="img" src="public/img/content/chess.png" alt="Chess" />
      </div> 
      <div class="text-center color-white">
        <h5 class="xs-no-br fw-200">
          แต่จะต้องทำ<span class="h3 fw-400">เชิงรุก</span>และ<span class="h3 fw-400">วางกลยุทธ์</span>
          ด้านการตลาด <br> ผ่านสื่อทั้งออนไลน์และออฟไลน์
        </h5>  
      </div>  
    </div> 
  </section>
