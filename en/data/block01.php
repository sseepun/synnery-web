<div class="section-12">
  ...
  <div class="grids no-gap" data-aos="fade-up" data-aos-delay="450">
    <?php
      $clients = [
        [
          'bg' => DOMAIN.'public/img/content/60.jpg',
          'icon' => DOMAIN.'public/img/clients/กรมอนามัย.svg',
          'title' => 'กรมอนามัย',
          'bgColor' => 'rgba(0,108,63,.7)',
          'link' => 'web-gov-standard.php',
        ], [
          'bg' => DOMAIN.'public/img/content/61.jpg',
          'icon' => DOMAIN.'public/img/clients/Asia-Pacific-Economic-Cooperation.svg',
          'title' => 'ความร่วมมือทางเศรษฐกิจ<br>ในเอเชียแปซิฟิก (เอเปค)',
          'bgColor' => 'rgba(43,48,125,.7)',
          'link' => 'web-gov-standard.php',
        ], [
          'bg' => DOMAIN.'public/img/content/62.jpg',
          'icon' => DOMAIN.'public/img/clients/กระทรวงวัฒนธรรม.svg',
          'title' => 'ศูนย์วัฒนธรรมอาเซียน<br>Asean Cultural Center',
          'bgColor' => 'rgba(38,15,71,.7)',
          'link' => 'web-gov-standard.php',
        ], [
          'bg' => DOMAIN.'public/img/content/63.jpg',
          'icon' => DOMAIN.'public/img/clients/กรมการขนส่งทางบก.svg',
          'title' => 'กรมการขนส่งทางบก',
          'bgColor' => 'rgba(102,66,132,.7)',
          'link' => 'web-gov-standard.php',
        ], [
          'bg' => DOMAIN.'public/img/content/64.jpg',
          'icon' => DOMAIN.'public/img/clients/สำนักงานคณะกรรมการกำกับกิจการพลังงาน.png',
          'title' => 'สำนักงานคณะกรรมการ<br>กำกับกิจการพลังงาน',
          'bgColor' => 'rgba(243,119,54,.7)',
          'link' => 'web-gov-standard.php',
        ], [
          'bg' => DOMAIN.'public/img/content/65.jpg',
          'icon' => DOMAIN.'public/img/clients/GSSD.png',
