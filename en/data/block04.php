...
<section data-section="2" class="section-01 section-padding pt-0 pb-5">
  <div class="pattern style-47">
    <div class="wrapper" value=".5">
      <img src="<?php echo DOMAIN ?>public/img/patterns/07.png" alt="Hero">
    </div>
  </div>
  <div class="pattern style-48">
    <div class="wrapper" value="-.5">
      <img src="<?php echo DOMAIN ?>public/img/patterns/08.png" alt="Hero">
    </div>
  </div>
  <div class="container">
      ...
      <?php for($i=0; $i<5; $i++){?>
        <div class="social-block">
          <div class="ss-card ss-card-36">
            <div class="icon">
              <img class="inactive" src="<?php echo DOMAIN ?>public/img/icon/social-0<?= ($i%5+1) ?>.png" alt="Icon Inactive" />
              <img class="active" src="<?php echo DOMAIN ?>public/img/icon/active-social-0<?= ($i%5+1) ?>.png" alt="Icon Active" />
            </div>
          </div>
        </div>
      <?php }?>
