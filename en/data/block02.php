<section class="section-10 section-padding pt-0">
  ...
  <div class="img-bg" style="background-image:url('<?php echo DOMAIN ?>public/img/bg/95.jpg'); background-position:top center;"></div>
            ...
            <div class="ss-card ss-card-29 box-shadow c-pointer">
              <div class="ss-img no-hover vertical-02">
                <div 
                  ...
                  style="background-image:url('<?php echo DOMAIN ?>public/img/content/minisite-gov-0<?= ($i%9+1) ?>.jpg');" 
                ></div>
              </div>
            </div> 
          </div>
